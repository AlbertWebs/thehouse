...
<div id="wrap" >
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                        <h1> All Products featured Product</h1>
                    </div>
                </div>
                  <hr />
                 <!--BLOCK SECTION -->
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            @foreach($Product as $value)
                                                <tr class="odd gradeX">
                                                    ...
                                                    ?>
                                                    <td class="center"><a href="{{url('admin/swap')}}/{{$value->id}}/{{$value->featured}}"   class="btn btn-{{$status_color}}"><i class="icon-{{$status_icon}} icon-white"></i> {{$status_text}}</a></td>
