		...
		<div class="outer-container">
			<div class="gallery-carousel owl-carousel owl-theme">
				...
				<div class="gallery-block">
					<div class="inner-box">
						<div class="image">
							<img src="{{asset('theme/images/gallery/1.jpg')}}" alt="" />
				...
				<div class="gallery-block">
					<div class="inner-box">
						<div class="image">
							<img src="{{asset('theme/images/gallery/2.jpg')}}" alt="" />
							<div class="overlay-box">
								<div class="overlay-inner">
									<div class="content">
										<ul class="options">
				...
				<div class="gallery-block">
					<div class="inner-box">
						<div class="image">
							<img src="{{asset('theme/images/gallery/3.jpg')}}" alt="" />
							<div class="overlay-box">
								<div class="overlay-inner">
									<div class="content">
										<ul class="options">
				...
				<div class="gallery-block">
					<div class="inner-box">
						<div class="image">
							<img src="{{asset('theme/images/gallery/4.jpg')}}" alt="" />
							<div class="overlay-box">
								<div class="overlay-inner">
									<div class="content">
										<ul class="options">
				...
				<div class="gallery-block">
					<div class="inner-box">
						<div class="image">
							<img src="{{asset('theme/images/gallery/5.jpg')}}" alt="" />
							<div class="overlay-box">
								<div class="overlay-inner">
									<div class="content">
										<ul class="options">
				...
				<div class="gallery-block">
					<div class="inner-box">
						<div class="image">
							<img src="{{asset('theme/images/gallery/6.jpg')}}" alt="" />
							<div class="overlay-box">
								<div class="overlay-inner">
									<div class="content">
										<ul class="options">
				...
				<div class="gallery-block">
					<div class="inner-box">
						<div class="image">
							<img src="{{asset('theme/images/gallery/7.jpg')}}" alt="" />
							<div class="overlay-box">
								<div class="overlay-inner">
									<div class="content">
										<ul class="options">
				...
				<div class="gallery-block">
					<div class="inner-box">
						<div class="image">
							<img src="{{asset('theme/images/gallery/8.jpg')}}" alt="" />
							<div class="overlay-box">
								<div class="overlay-inner">
									<div class="content">
										<ul class="options">
